...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright CesarRomagnolo, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/OhmBass-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/OhmBass-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/OhmBass-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/OhmBass-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/OhmBass-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/OhmBass-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/OhmBass-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/OhmBass.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/OhmBass.iss",inplace=1):
